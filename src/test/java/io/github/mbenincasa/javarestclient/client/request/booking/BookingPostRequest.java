package io.github.mbenincasa.javarestclient.client.request.booking;
...
public class BookingPostRequest {
    ...
    private BookingPostRequestDates bookingdates;
    ...
    public BookingPostRequest(String firstname, String lastname, int totalprice, boolean depositpaid, BookingPostRequestDates bookingdates, String additionalneeds) {
    ...
    public BookingPostRequestDates getBookingdates() {
        return bookingdates;
    }

    public void setBookingdates(BookingPostRequestDates bookingdates) {
        this.bookingdates = bookingdates;
    }
    ...
    public static class BookingPostRequestDates {
        ...
        public BookingPostRequestDates() {
        }

        public BookingPostRequestDates(String checkin, String checkout) {
